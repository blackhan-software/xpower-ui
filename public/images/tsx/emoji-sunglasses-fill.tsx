...
export function EmojiSunglasses({
    ...
    return fill
        ? <svg className='bi bi-emoji-sunglasses-fill' xmlns='http://www.w3.org/2000/svg' fill='currentColor' height={height} width={width} viewBox='0 0 16 16' style={style}>
        ...
        : <svg className='bi bi-emoji-sunglasses' xmlns='http://www.w3.org/2000/svg' fill='currentColor' height={height} width={width} viewBox='0 0 16 16' style={style}>
