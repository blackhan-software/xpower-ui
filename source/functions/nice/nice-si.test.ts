...
describe("nice_si w/{p=6..0, b=1e18}", () => {
    it("should produce 3.141593", () => {
        expect(nice_si(3.141592654 * 1e18 * 1e0, { precision: 6, base: 1e18 })).toEqual("3.141593");
        expect(nice_si(BigInt(3.141592654 * 1e18 * 1e0), { precision: 6, base: 1e18 })).toEqual("3.141593");
    });
    it("should produce 3.14159K", () => {
        expect(nice_si(3.141592654 * 1e18 * 1e3, { precision: 5, base: 1e18 })).toEqual("3.14159K");
        expect(nice_si(BigInt(3.141592654 * 1e18 * 1e3), { precision: 5, base: 1e18 })).toEqual("3.14159K");
    });
    it("should produce 3.1416M", () => {
        expect(nice_si(3.141592654 * 1e18 * 1e6, { precision: 4, base: 1e18 })).toEqual("3.1416M");
        expect(nice_si(BigInt(3.141592654 * 1e18 * 1e6), { precision: 4, base: 1e18 })).toEqual("3.1416M");
    });
    it("should produce 3.142G", () => {
        expect(nice_si(3.141592654 * 1e18 * 1e9, { precision: 3, base: 1e18 })).toEqual("3.142G");
        expect(nice_si(BigInt(3.141592654 * 1e18 * 1e9), { precision: 3, base: 1e18 })).toEqual("3.142G");
    });
    it("should produce 3.14T", () => {
        expect(nice_si(3.141592654 * 1e18 * 1e12, { precision: 2, base: 1e18 })).toEqual("3.14T");
        expect(nice_si(BigInt(3.141592654 * 1e18 * 1e12), { precision: 2, base: 1e18 })).toEqual("3.14T");
    });
    it("should produce 3.1P", () => {
        expect(nice_si(3.141592654 * 1e18 * 1e15, { precision: 1, base: 1e18 })).toEqual("3.1P");
        expect(nice_si(BigInt(3.141592654 * 1e18 * 1e15), { precision: 1, base: 1e18 })).toEqual("3.1P");
    });
    it("should produce 3E", () => {
        expect(nice_si(3.141592654 * 1e18 * 1e18, { precision: 0, base: 1e18 })).toEqual("3E");
        expect(nice_si(BigInt(3.141592654 * 1e18 * 1e18), { precision: 0, base: 1e18 })).toEqual("3E");
    });
    ...
    it("should produce 3.14Y", () => {
        expect(nice_si(3.141592654 * 1e18 * 1e24, { precision: 2, base: 1e18 })).toEqual("3.14Y");
        expect(nice_si(BigInt(3.141592654 * 1e18 * 1e24), { precision: 2, base: 1e18 })).toEqual("3.14Y");
    });
    it("should produce 3.142E27", () => {
        expect(nice_si(3.141592654 * 1e18 * 1e27, { precision: 3, base: 1e18 })).toEqual("3.142E27");
        expect(nice_si(BigInt(3.141592654 * 1e18 * 1e27), { precision: 3, base: 1e18 })).toEqual("3.142E27");
    });
});
