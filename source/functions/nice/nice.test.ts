...
describe("nice w/{p=6..0, b=1e18, s='π'}", () => {
    it("should produce 3.141593π", () => {
        expect(nice(1e18 * 3.141592654, { precision: 6, base: 1e18, suffix: 'π' })).toEqual("3.141593π");
        expect(nice(BigInt(1e18 * 3.141592654), { precision: 6, base: 1e18, suffix: 'π' })).toEqual("3.141593π");
    });
    it("should produce 31.41593π", () => {
        expect(nice(1e18 * 31.41592654, { precision: 5, base: 1e18, suffix: 'π' })).toEqual("31.41593π");
        expect(nice(BigInt(1e18 * 31.41592654), { precision: 5, base: 1e18, suffix: 'π' })).toEqual("31.41593π");
    });
    it("should produce 314.1593π", () => {
        expect(nice(1e18 * 314.1592654, { precision: 4, base: 1e18, suffix: 'π' })).toEqual("314.1593π");
        expect(nice(BigInt(1e18 * 314.1592654), { precision: 4, base: 1e18, suffix: 'π' })).toEqual("314.1593π");
    });
    it("should produce 3'141.593π", () => {
        expect(nice(1e18 * 3_141.592654, { precision: 3, base: 1e18, suffix: 'π' })).toEqual("3'141.593π");
        expect(nice(BigInt(1e18 * 3_141.592654), { precision: 3, base: 1e18, suffix: 'π' })).toEqual("3'141.593π");
    });
    it("should produce 31'415.93π", () => {
        expect(nice(1e18 * 31_415.92654, { precision: 2, base: 1e18, suffix: 'π' })).toEqual("31'415.93π");
        expect(nice(BigInt(1e18 * 31_415.92654), { precision: 2, base: 1e18, suffix: 'π' })).toEqual("31'415.93π");
    });
    it("should produce 314'159.3π", () => {
        expect(nice(1e18 * 314_159.2654, { precision: 1, base: 1e18, suffix: 'π' })).toEqual("314'159.3π");
        expect(nice(BigInt(1e18 * 314_159.2654), { precision: 1, base: 1e18, suffix: 'π' })).toEqual("314'159.3π");
    });
    it("should produce 3'141'593π", () => {
        expect(nice(1e18 * 3_141_592.654, { precision: 0, base: 1e18, suffix: 'π' })).toEqual("3'141'593π");
        expect(nice(BigInt(1e18 * 3_141_592.654), { precision: 0, base: 1e18, suffix: 'π' })).toEqual("3'141'593π");
    });
});
