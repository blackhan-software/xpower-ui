...
const THOR_MOE_V7b = process.env.THOR_MOE_V7b ?? '0x1A748bd58f10eA8dA562605Fb1D24B53461Cf972';
assert(THOR_MOE_V7b, 'missing THOR_MOE_V7b env variable');
const LOKI_MOE_V7b = process.env.LOKI_MOE_V7b ?? '0x8dd3fB456f8d36191D94572802D7715a0665106B';
assert(LOKI_MOE_V7b, 'missing LOKI_MOE_V7b env variable');
const ODIN_MOE_V7b = process.env.ODIN_MOE_V7b ?? '0x8Be4ddA5a40D02458510124EF849aFd1086b0444';
assert(ODIN_MOE_V7b, 'missing ODIN_MOE_V7b env variable');
const THOR_MOE_V7c = process.env.THOR_MOE_V7c ?? '0x0000000000000000000000000000000000000000';
assert(THOR_MOE_V7c, 'missing THOR_MOE_V7c env variable');
const LOKI_MOE_V7c = process.env.LOKI_MOE_V7c ?? '0x0000000000000000000000000000000000000000';
assert(LOKI_MOE_V7c, 'missing LOKI_MOE_V7c env variable');
const ODIN_MOE_V7c = process.env.ODIN_MOE_V7c ?? '0x0000000000000000000000000000000000000000';
assert(ODIN_MOE_V7c, 'missing ODIN_MOE_V7c env variable');
...
const XPOW_NFT_V7c = process.env.XPOW_NFT_V7c ?? '0x0000000000000000000000000000000000000000';
...
const XPOW_PPT_V7c = process.env.XPOW_PPT_V7c ?? '0x0000000000000000000000000000000000000000';
...
const XPOW_PTY_V7c = process.env.XPOW_PTY_V7c ?? '0x0000000000000000000000000000000000000000';
...
const XPOW_MTY_V7c = process.env.XPOW_MTY_V7c ?? '0x0000000000000000000000000000000000000000';
...
const THOR_SOV_V7b = process.env.THOR_SOV_V7b ?? '0x1D8AeCF8EdEe3dd2610339392dE578734d7C818f';
assert(THOR_SOV_V7b, 'missing THOR_SOV_V7b env variable');
const LOKI_SOV_V7b = process.env.LOKI_SOV_V7b ?? '0x5ea0AFe9002C76956A3fc70df36aD2e5cCF4E3da';
assert(LOKI_SOV_V7b, 'missing LOKI_SOV_V7b env variable');
const ODIN_SOV_V7b = process.env.ODIN_SOV_V7b ?? '0x633759DC1f5fc1b8a9c1674e6F8eB546fAbe6088';
assert(ODIN_SOV_V7b, 'missing ODIN_SOV_V7b env variable');
const THOR_SOV_V7c = process.env.THOR_SOV_V7c ?? '0x0000000000000000000000000000000000000000';
assert(THOR_SOV_V7c, 'missing THOR_SOV_V7c env variable');
const LOKI_SOV_V7c = process.env.LOKI_SOV_V7c ?? '0x0000000000000000000000000000000000000000';
assert(LOKI_SOV_V7c, 'missing LOKI_SOV_V7c env variable');
const ODIN_SOV_V7c = process.env.ODIN_SOV_V7c ?? '0x0000000000000000000000000000000000000000';
assert(ODIN_SOV_V7c, 'missing ODIN_SOV_V7c env variable');
// MOE contract images
