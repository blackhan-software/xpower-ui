...
const THOR_MOE_V7c = process.env.THOR_MOE_V7c ?? '0x6Fb67AB42e3DD49514036EA1AbB973D9EFD4CB91';
assert(THOR_MOE_V7c, 'missing THOR_MOE_V7c env variable');
const LOKI_MOE_V7c = process.env.LOKI_MOE_V7c ?? '0xe2Dc552ab6848C2126229554ab3411911C28547b';
assert(LOKI_MOE_V7c, 'missing LOKI_MOE_V7c env variable');
const ODIN_MOE_V7c = process.env.ODIN_MOE_V7c ?? '0xFd9A6B06d4b0fB4ed04f12D3B501D1475e075B87';
...
const THOR_SOV_V7c = process.env.THOR_SOV_V7c ?? '0x58699755435B93690afd0DA4E04f3668d7915BD9';
assert(THOR_SOV_V7c, 'missing THOR_SOV_V7c env variable');
const LOKI_SOV_V7c = process.env.LOKI_SOV_V7c ?? '0xFecbB287042F57BaC758Ec606C5AeD3A040aBeF8';
assert(LOKI_SOV_V7c, 'missing LOKI_SOV_V7c env variable');
const ODIN_SOV_V7c = process.env.ODIN_SOV_V7c ?? '0x4a5Ab4Ea038E174535563bF8C92C17a20851c088';
